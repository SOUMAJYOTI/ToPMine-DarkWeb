...
public class RunPhraseLDA {
	public static final String MAIN_PATH = "F:/ToPMine-Spark-master/TopMine-Spark-master/phrase-construction/src/resources/orig_inp_out/";
	public static void main(String[] args) throws IOException{
		

		//input 
		String trainFile = MAIN_PATH + "inputInter.txt";
//		String trainFile = "ap_sample_output/ap_sample_normalLDA.txt"; // input file, training file
		String testFile = null;//"ap_sample_output/ap_sample_partitionedTest.txt"; //test file, set to null if no test
		
		//output
		String wordTopicAssign = MAIN_PATH + "output/" + "wordTopicAssign.txt"; // word topic assignment
		String topicFile = MAIN_PATH + "output/" + "topics.txt";	//output all topics, i.e. distribution over words
		String paraFile = MAIN_PATH + "output/" + "phrLDAInfo.txt";//output the parameter information
		int K = 20; // number of topics
